...
public class GhostMachineSlotWidget extends ItemSlot {

    private static final int SYNC_CIRCUIT_INDEX = 10;

    public GhostMachineSlotWidget() {
    ...
    public ItemSlot slot(ModularSlot slot) {
        ItemSlotSH sh = new GhostMachineSyncHandler(slot);
    ...
    @Override
    public @NotNull GhostMachineSlotWidget.GhostMachineSyncHandler getSyncHandler() {
        return (GhostMachineSyncHandler) super.getSyncHandler();
    }
    ...
    private static class GhostMachineSyncHandler extends ItemSlotSH {

        public GhostMachineSyncHandler(ModularSlot slot) {
            super(slot);
        }
