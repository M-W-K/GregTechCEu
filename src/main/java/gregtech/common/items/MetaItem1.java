...
public class MetaItem1 extends StandardMetaItem {
    ...
    public void registerSubItems() {
        ...
        TOOL_DATA_STICK = addItem(261, "tool.datastick").addComponents(new DataItemBehavior(false, 3));
        TOOL_DATA_ORB = addItem(262, "tool.dataorb").addComponents(new DataItemBehavior(false, 6));
        TOOL_DATA_MODULE = addItem(263, "tool.datamodule").addComponents(new DataItemBehavior(true, 10));
